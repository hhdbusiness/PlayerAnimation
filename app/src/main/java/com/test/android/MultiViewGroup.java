...
public class MultiViewGroup extends FrameLayout {
   ...
   //startScroll 滑屏
    ...
    private void init() {
		...
		LinearLayout oneLLL = new LinearLayout(mContext);
		oneLLL.setBackgroundColor(Color.BLACK);
		oneLL.addView(oneLLL);
        addView(oneLL);
...
//		setMeasuredDimension(widthScreen, 500);
		...
		for (int i = 0; i < childCount; i++) {
			...
			// 设置每个子视图的大小 ， 即全屏
			child.measure(widthScreen, heightScreen);
		}*/
	}
